...
public class TelaPesquisaCiosConfirmados extends javax.swing.JFrame {
    ...
    public void IniciaTabela(){
        ...
        String sql = ("select codcio, dataCio, codVaca, nomeVaca, codTouro, nomeTouro , confirmado, dataConfirmacao, repetiuCio, obs from tb_cio where perdeu = false and confirmado = true;");
    ...
    private void PesquisaBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PesquisaBActionPerformed
     Connection con =null;
        ...
        String sql = ("select codcio, dataCio, codVaca, nomeVaca, codTouro, nomeTouro , confirmado, dataConfirmacao, repetiuCio, obs from tb_cio where nomeVaca like ? and perdeu = false and confirmado = true;");
        DefaultTableModel table = (DefaultTableModel) listaCios.getModel();
